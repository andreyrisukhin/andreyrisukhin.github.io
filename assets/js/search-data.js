    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/time-at-perceptron-ai/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=6OrsxqIAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/AndreyRisuka", "_blank");
        },
      },{
      id: 'light-theme',
